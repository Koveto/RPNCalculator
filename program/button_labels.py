...
class ButtonLabels:
    ...
    ROW_7_A = (SUM_PLUS,             RECIPROCAL,      SQRT,          LOGARITHM,       NATURAL_LOG,    PERMUTATION)
    ...
    ROW_7_B = (SUM_MINUS,            POWER,           SQUARE,        POWER_OF_TEN,    EXPONENTIAL,               COMBINATION)
    ROW_6_B = (COMPLEX_NUMBER,       PERCENT,         PI,            ARCSINE,         ARCCOSINE,                 ARCTANGENT)
    ROW_5_B = (ENTER,                ENTER,           MEAN,          ROUND,           DELETE,                    CLEAR)
    ROW_4_B = (REAL,                 PARENTHESIS_L,   HEXADECIMAL,   PARENTHESIS_R,   MODULUS,                   None)
